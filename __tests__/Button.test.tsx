...
describe('Button component', () => {
  ...
  test('renders button with label and icon by default', () => {
    const { getByText, getByTestId } = render(
      <Button linkField={linkField as LinkField} label={label as KeyTextField} />
    );
  ...
  test('renders button without icon when showIcon is false', () => {
    const { queryByTestId } = render(
      <Button linkField={linkField as LinkField} label={label as KeyTextField} showIcon={false} />
    );
  ...
  test('applies custom class name to button', () => {
    ...
    const { container } = render(
      <Button linkField={linkField as LinkField} label={label as KeyTextField} className={customClassName} />
    );
